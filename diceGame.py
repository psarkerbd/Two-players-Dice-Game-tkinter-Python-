...
def thrown_Dice(p, playerName , score, ftypeuno, mainscore):
    ...
    imageName = "images/dice_" + str(p) + ".jpg";
    #print(imageName);
...
def headToheadTable(winner, headplayer, tailplayer, ftypeuno):
    ...
    headplayerLabel = Label(root, text = headplayer , width = 10);
    ...
    tailplayerLabel = Label(root, text = tailplayer, width = 10);
...
def theWinner(playerName, headplayer, tailplayer, ftypeuno):
    ...
    img = Image.open("images/emo.jpg");  # file name with extension
...
def tossWindow(ftypeuno):
    ...
    headimg = Image.open("images/head.jpg");
    tailimg = Image.open("images/tail.jpg");
